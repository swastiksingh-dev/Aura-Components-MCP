...
check('trending 4 surfaces', tr && tr.components && tr.skills && tr.window.includes('days') && Array.isArray(tr.editorial_picks) && tr.editorial_picks.length > 0, Object.keys(tr || {}).join(','));
